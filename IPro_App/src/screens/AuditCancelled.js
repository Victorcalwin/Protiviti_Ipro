...
const AuditCancelled = ({navigation}) => {
        ...
        <View style={{marginBottom:40, marginHorizontal: '7%' }}>
          ...
          <View style={{ backgroundColor: '#fff', borderRadius: 20, marginBottom: 20 }}>
            <View style={{ alignItems: 'flex-end' }}>
              <Text style={{ width: '40%', color: '#fff', backgroundColor: '#D74B29', textAlign: 'center', paddingVertical: 3, borderBottomLeftRadius: 20, borderTopRightRadius: 20 }}>CANCELLED</Text>
            </View>
          ...
          <View style={{marginBottom:40}}>
            <Text style={{ fontSize: 19,marginBottom:5,fontWeight:'600' }}>Reasons for Cancellation</Text>
