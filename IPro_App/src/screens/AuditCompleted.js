...
const AuditCompleted = ({navigation}) => {
        ...
        <View style={{ marginBottom: 40, marginHorizontal: '7%' }}>
          ...
          <View style={{ backgroundColor: '#fff', borderRadius: 20, marginBottom: 20 }}>
            <View style={{ alignItems: 'flex-end' }}>
              <Text style={{ width: '40%', color: '#fff', backgroundColor: '#C8C9C7', textAlign: 'center', paddingVertical: 3, borderBottomLeftRadius: 20, borderTopRightRadius: 20 }}>COMPLETED</Text>
            </View>
