...
export default function Checklist1({ navigation }) {
    return (
        <ScrollView style={{ backgroundColor: '#000', flex: 1 }}>
            <View>
                <View style={{ marginHorizontal: '4%', paddingTop: 20, }}>
                    <View style={{ justifyContent: 'center', alignSelf: 'center' }}>
                        <Image style={styles.Group} source={require('../../images/pvr.png')} />
                    </View>
                    <View style={{ marginTop: 60, alignItems: 'center' }}>
                        <Image style={styles.Financial} source={require('../../images/Check1.png')} />
                    </View>
                    <View style={{ justifyContent: 'center', alignSelf: 'center', flexDirection: 'row', marginVertical: 30, }}>
                        ...
                        {/* <View><Text style={{ margin: 5, fontSize: 17, color: '#E3E3E3', }}>2</Text></View>
                        <View><Text style={{ margin: 5, fontSize: 17, color: '#E3E3E3', }}>3</Text></View> */}
                    </View>
                    <View>
                        <Text style={{ fontFamily: 'BarlowCondensed-Regular', fontSize: 24, fontWeight: 'bold', color: '#fff', textAlign: 'center' }}>Scheduled Audits</Text>
                    ...
                    <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginVertical: 30 }}>
                        ...
                        <View style={{ backgroundColor: '#e3b912', width: '40%', paddingVertical: 10, borderRadius: 5 }}>
                            <Text style={{ fontSize: 16, fontWeight: '500', textAlign: 'center', color: '#fff' }} onPress={() => navigation.navigate('checklist2')}>Next</Text>
                        </View>
                    </View>
                </View>
            </View>
